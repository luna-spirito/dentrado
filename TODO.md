...
* `[[html]] … [[/html]]` (bau 182, it-cea-wiki 244, rpc 99, sci-alliance 129…):
  живой рендерит каждый блок как `<iframe src="/<page>/html/<хэш>" class="html-block-iframe">`
  — отдельный сырой HTML-документ на маршрут. Нужны: verbatim-кадр (по образцу `[[code]]`),
  стабильный хэш содержимого и серверный маршрут раздачи. Парсер — мелочь, раздача — серверщина.
